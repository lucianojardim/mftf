CREATE TABLE IF NOT EXISTS `LocalityCity` (
	`LocalityCityId`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,
	`LocalityCityName`	TEXT NOT NULL UNIQUE,
	`LocalityStateId`	INTEGER NOT NULL,
	FOREIGN KEY(`LocalityStateId`) REFERENCES `LocalityState`(`LocalityStateId`) ON DELETE RESTRICT ON UPDATE RESTRICT
);
INSERT INTO `LocalityCity` 
(`LocalityCityId`, `LocalityCityName`, `LocalityStateId`) VALUES
(1, 'Afonso Cláudio', 8),
